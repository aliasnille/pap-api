**FYI:** PAP-API isn't an active project! **But, PAP-API Lite is your new full-fledged alternative to PAP-API. [Get started with PAP-API Lite now (in Swedish)!](https://api.papapi.se/lite/docs/)**
